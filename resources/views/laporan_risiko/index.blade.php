...
@push('datatable')
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
               type: 'GET',
               url: "{{url('laporan_risiko/view_data?unit='.$unit_id)}}&periode="+periode,
               data: "id=id",
               beforeSend: function(){
        ...
        function cari(a){
           ...
           $.ajax({
               type: 'GET',
               url: "{{url('laporan_risiko/view_data?unit='.$unit_id)}}&periode="+a,
               data: "id=id",
               beforeSend: function(){
                    $("#tampilkan").html('<center><img src="{{url(url_link().'/img/loading.gif')}}" width="3%"> Proses Data.............</center>');
               },
        ...
        function cetak(a){
            var periode=$('#periode').val();
            window.location.assign("{{url('excel_laporan_risiko')}}?unit="+a+"&periode="+periode);
