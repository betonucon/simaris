            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Nama Link Halaman</label>
                    <input class="form-control item"   type="text" name="name" value="">
                  </div>
                  <div class="form-group">
                    <label>Judul Halaman</label>
                    <input class="form-control item"   type="text" name="title" value="">
                  </div>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control"   rows="3" name="isi"></textarea>               </div>
                  </div>
