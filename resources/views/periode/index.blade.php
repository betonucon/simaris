...
<div class="modal fade" id="modal-default" style="display: none;">
    <div class="modal-dialog modal-lg" style="margin-top: 2%;width:50%">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="mysimpan_data" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  name="start_date"  id="datepicker" value="" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>End Date</label>
                        <input type="text"  name="end_date" id="datepicker1" value="" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Tahun</label>
...
@push('datatable')
    <script>
        ...
        function cari(a){
           ...
           $.ajax({
               type: 'GET',
               url: "{{url('periode/view_data')}}?name="+a,
               data: "id=id",
               success: function(msg){
                   $("#tampilkan").html(msg);
